...
var ft1950959 = {
	params:window.ftParams_1950959||"",
	confID:window.ftConfID_1950959||"0",
	guid:window.ftGUID_1950959||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1950959 && window.ftImp1950959.impID || '',
	pID:1950959,
	creativeID:"1385470",
	campaignID: "64642",
	exttrack:["https://pixel.mathtag.com/event/img?mt_id=1044321&mt_adid=112182&v1=&v2=&v3=&s1=&s2=&s3=&mt_nsync=1"],
	extscript:[""],
	width:"728",
	height:"90",
	altimg:"http://cdn.flashtalking.com/xre/195/1950959/1385470/image/1385470.gif",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/3/64642;1950959;202;pixel;DeveloperMedia;AmazonAWSMarketplaceAwarenessQ22016AllDeveloperMediaBannerRONAppDMMTNAEN728x90/?",
    stump: "http://servedby.flashtalking.com",
	altimghref:"http://servedby.flashtalking.com/click/3/64642;1950959;1385470;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://aws.amazon.com/marketplace/b/2649279011/?sc_channel=ba&sc_campaign=jmwl_mm_40002016&sc_publisher=DeveloperMedia&sc_medium=medium&sc_detail=728x90&sc_content=CQLP_AppD&sc_country=NA&sc_geo=namer&sc_category=mult&sc_segment=MMT&sc_outcome=multi",
	switchArray:["altimg", "altimghref", "cdnSrc", "cdnGUID", "iDeviceImp", "statBaseURL", "viewableImpressionURL", "cdnSrc", "iDeviceImp"],
	statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?68961138-1950959;1385470;",
	divID:"ftdiv1950959",
	altimgID:"ftalt1950959",
    imgID: "ftImg1950959",
    frameID:"ftframe1950959",
	alttext:"Click here",
	altimgtarget:"_blank",
	altimgborder:"0",
	centreAd:true,
	...
	iDeviceImp:"http://servedby.flashtalking.com/imp/3/64642;1950959;207;guid;DeveloperMedia;AmazonAWSMarketplaceAwarenessQ22016AllDeveloperMediaBannerRONAppDMMTNAEN728x90/?ft_guid=",
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1950959[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	adDisplayed: false,
    w: window,
    qsVars:[
        ["ftguid","ftGUID_1950959"],
        ["ftcfid","ftConfID_1950959"],
        ["ftcustom","ftCustom_1950959"],
        ["fttime","ftTimestamp_1950959"],
        ["ftsection","ftSection_1950959"],
        ["ft_id", "ftID"],
        ['ftimpid', 'ftImp1950959', 'impID']
    ],
	api: {
		fallbackAPI: {
            ft: null,
	...
	scriptLocation: document.getElementById('ftscript_m1950959'),
	$:function(el){
		var o=this,
		x = el||o.divID,
		p={o:o};
	...
	outputDiv:function(frame){
		...
		div += o[content]();
		div += '</div>';
		if(window.ftImp1950959 && window.ftImp1950959.jsAppend) {
