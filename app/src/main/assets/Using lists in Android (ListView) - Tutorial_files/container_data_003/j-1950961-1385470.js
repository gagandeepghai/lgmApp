...
var ft1950961 = {
	params:window.ftParams_1950961||"",
	confID:window.ftConfID_1950961||"0",
	guid:window.ftGUID_1950961||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1950961 && window.ftImp1950961.impID || '',
	pID:1950961,
	creativeID:"1385470",
	campaignID: "64642",
	...
	width:"728",
	height:"90",
	altimg:"http://cdn.flashtalking.com/xre/195/1950961/1385470/image/1385470.gif",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/3/64642;1950961;202;pixel;DeveloperMedia;AmazonAWSMarketplaceAwarenessQ22016AllDeveloperMediaBannerRONAppDENTNAEN728x90/?",
    stump: "http://servedby.flashtalking.com",
	altimghref:"http://servedby.flashtalking.com/click/3/64642;1950961;1385470;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://aws.amazon.com/marketplace/b/2649279011/?sc_channel=ba&sc_campaign=jmwl_mm_40002016&sc_publisher=DeveloperMedia&sc_medium=medium&sc_detail=728x90&sc_content=CQLP_AppD&sc_country=NA&sc_geo=namer&sc_category=mult&sc_segment=ENT&sc_outcome=multi",
	switchArray:["altimg", "altimghref", "cdnSrc", "cdnGUID", "iDeviceImp", "statBaseURL", "viewableImpressionURL", "cdnSrc", "iDeviceImp"],
	statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?68961168-1950961;1385470;",
	divID:"ftdiv1950961",
	altimgID:"ftalt1950961",
    imgID: "ftImg1950961",
    frameID:"ftframe1950961",
	alttext:"Click here",
	altimgtarget:"_blank",
	altimgborder:"0",
	centreAd:true,
	...
	iDeviceImp:"http://servedby.flashtalking.com/imp/3/64642;1950961;207;guid;DeveloperMedia;AmazonAWSMarketplaceAwarenessQ22016AllDeveloperMediaBannerRONAppDENTNAEN728x90/?ft_guid=",
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1950961[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	adDisplayed: false,
    w: window,
    qsVars:[
        ["ftguid","ftGUID_1950961"],
        ["ftcfid","ftConfID_1950961"],
        ["ftcustom","ftCustom_1950961"],
        ["fttime","ftTimestamp_1950961"],
        ["ftsection","ftSection_1950961"],
        ["ft_id", "ftID"],
        ['ftimpid', 'ftImp1950961', 'impID']
    ],
	api: {
		fallbackAPI: {
            ft: null,
	...
	scriptLocation: document.getElementById('ftscript_m1950961'),
	$:function(el){
		var o=this,
		x = el||o.divID,
		p={o:o};
	...
	outputDiv:function(frame){
		...
		div += o[content]();
		div += '</div>';
		if(window.ftImp1950961 && window.ftImp1950961.jsAppend) {
